// components/ui/SuperAdminDashboard.tsx
"use client"
  ...
  return (
    <div className="min-h-screen bg-blue-100 p-6">
      ...
      <header className="flex justify-between items-center mb-6">
        <h1 className="text-2xl font-bold text-blue-700">CivicFix Super Admin</h1>
...
<footer className="mt-6 text-center text-sm text-gray-500">
  © {new Date().getFullYear()} CivicFix | Super Admin Dashboard
</footer>
    </div>
  )
}
